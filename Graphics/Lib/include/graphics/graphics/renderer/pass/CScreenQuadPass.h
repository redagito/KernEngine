...
public:
  ...
  * buffer.
  */
  void draw(CTexture *diffuseGlowTexture, CTexture *lightTexture,
            CTexture *depthTexture, const glm::mat4 &inverseViewProj,
            CFrameBuffer *fbo, const IGraphicsResourceManager *manager);
