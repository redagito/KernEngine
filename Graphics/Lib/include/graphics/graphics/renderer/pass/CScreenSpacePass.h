...
public:
  ...
  */
  void draw(const IGraphicsResourceManager *manager, CFrameBuffer *fbo,
            CTexture *texture0 = nullptr, CTexture *texture1 = nullptr,
            CTexture *texture2 = nullptr, CTexture *texture3 = nullptr);

private:
  std::unique_ptr<CMesh> m_quad =
      nullptr;                /**< Dummy mesh for fullscreen quad. */
