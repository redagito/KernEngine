...
public:
  ...
  SceneObjectId createObject(ResourceId mesh, ResourceId material,
                             const glm::vec3 &position,
                             const glm::quat &rotation,
                             const glm::vec3 &scale) override;

  bool getObject(SceneObjectId id, ResourceId &mesh, ResourceId &material,
  ...
  SceneObjectId createPointLight(const glm::vec3 &position, float radius,
                                 const glm::vec3 &color, float intensity,
                                 bool castsShadow) override;

  bool getPointLight(SceneObjectId id, glm::vec3 &position, float &radius,
  ...
  SceneObjectId createDirectionalLight(const glm::vec3 &direction,
                                       const glm::vec3 &color, float intensity,
                                       bool castsShadow) override;

  bool getDirectionalLight(SceneObjectId id, glm::vec3 &direction,
                           glm::vec3 &color, float &intensity,
                           bool &castsShadow) const override;

  void setDirectionalLight(SceneObjectId id, const glm::vec3 &direction,
                           const glm::vec3 &color, float intensity,
                           bool castsShadow) override;
  ...
  void getVisibleObjects(const ICamera &camera,
                         ISceneQuery &query) const override;
...
private:
  ...
  std::vector<SSceneDirectionalLight>
      m_directionalLights; /**< Directional lights. */
