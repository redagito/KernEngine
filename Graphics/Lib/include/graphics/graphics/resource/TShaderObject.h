...
*/
template <GLenum ShaderType> class TShaderObject
{
public:
  /**
  ...
  */
  ...
  /**
  * \brief Returns compile error string if a previous call to init returned
  * false.
  */
...
template <GLenum ShaderType> TShaderObject<ShaderType>::~TShaderObject()
{
...
template <GLenum ShaderType> GLuint TShaderObject<ShaderType>::getId() const
{
  return m_objectId;
}

template <GLenum ShaderType> bool TShaderObject<ShaderType>::isValid() const
{
  return m_valid;
}
