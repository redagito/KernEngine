...
public:
  ...
  */
  void setFromCameraParameters(float viewAngle, float screenRatio, float nearZ,
                               float farZ, glm::vec3 &position, glm::vec3 &look,
                               glm::vec3 &up);
  ...
  */
  void setFromViewProjectionClipSpaceApproach(const glm::mat4 &view,
                                              const glm::mat4 &proj);
