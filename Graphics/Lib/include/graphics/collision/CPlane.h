...
public:
  ...
  void set3Points(const glm::vec3 &v1, const glm::vec3 &v2,
                  const glm::vec3 &v3);
...
private:
  glm::vec3 m_normal =
      glm::vec3(0.f, 1.f, 0.f); /**< Stores the plane normal. */
  float m_d =
      0.f; /**< Represents the regular euclidean distance from the origin. */
};