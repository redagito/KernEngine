...
bool load(const std::string &file, CResourceManager &manager, SShader &shader)
{
  ...
  {
    if (!loadShaderFromIni(file, vertex, tessControl, tessEval, geometry,
                           fragment))
    {
      return false;
    }
  ...
  {
    if (!loadShaderFromJson(file, vertex, tessControl, tessEval, geometry,
                            fragment))
    {
      return false;
    }
  ...
  if (vertex.empty())
  {
    LOG_ERROR("The shader program file %s is missing a vertex shader source "
              "file specifier.",
              file.c_str());
    return false;
  }
  ...
  {
    LOG_ERROR("The vertex shader source file %s, specified in the shader "
  ...
  {
    LOG_ERROR("The fragment shader source file %s, specified in the shader "
              "program file %s could not "
              "be loaded.",
  ...
  if (!tessControl.empty())
  {
    ...
    {
      LOG_ERROR("The tessellation control shader source file %s, specified in "
                "the shader program "
  ...
  if (!tessEval.empty())
  {
    ...
    {
      LOG_ERROR("The tessellation evaluation shader source file %s, specified "
                "in the shader "
  ...
  if (!geometry.empty())
  {
    ...
    {
      LOG_ERROR("The geometry shader source file %s, specified in the shader "
