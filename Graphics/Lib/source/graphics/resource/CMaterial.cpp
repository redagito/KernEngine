...
CMaterial::CMaterial(const CTexture *diffuse, const CTexture *normal,
                     const CTexture *specular, const CTexture *glow,
                     const CTexture *alpha)
    : m_diffuseTexture(nullptr), m_normalTexture(nullptr),
      m_specularTexture(nullptr), m_glowTexture(nullptr),
      m_alphaTexture(nullptr)
{
  init(diffuse, normal, specular, glow, alpha);
}

bool CMaterial::init(const CTexture *diffuse, const CTexture *normal,
                     const CTexture *specular, const CTexture *glow,
                     const CTexture *alpha)
{
