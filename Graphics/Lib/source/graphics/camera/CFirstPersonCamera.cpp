...
CFirstPersonCamera::CFirstPersonCamera(const glm::vec3 &position,
                                       const glm::vec3 &target,
                                       const glm::vec3 &up, float fieldOfView,
...
{
  glm::vec3 forward =
      TransformUtils::rotate(glm::vec3(0.0f, 1.0f, 0.0f), amount,
...
void CFirstPersonCamera::lookAt(const glm::vec3 &target,
                                const glm::vec3 & /* up */)
{
...
void CFirstPersonCamera::lookAt(const glm::vec3 &eye, const glm::vec3 &target,
                                const glm::vec3 &up)
{
  m_position = eye;
  lookAt(target, up);
...
void CFirstPersonCamera::setProjection(float fieldOfView, float aspectRatio,
...
void CFirstPersonCamera::updateView()
{
  ...
  m_view =
      glm::lookAt(m_position, m_position + forward, glm::vec3(0.0, 1.0f, 0.0f));
}