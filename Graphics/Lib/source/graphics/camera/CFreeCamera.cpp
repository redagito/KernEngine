...
CFreeCamera::CFreeCamera(const glm::vec3 &position, const glm::vec3 &target,
...
void CFreeCamera::lookAt(const glm::vec3 &eye, const glm::vec3 &target,
                         const glm::vec3 &up)
{
  m_position = eye;
  lookAt(target, up);
...
void CFreeCamera::setProjection(float fieldOfView, float aspectRatio,
