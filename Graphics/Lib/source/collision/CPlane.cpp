...
void CPlane::setCoefficients(const glm::vec4 &v) { setCoefficients(v.x, v.y, v.z, v.w); }
...
float CPlane::distance(const glm::vec3 &p) const { return m_d + glm::dot(m_normal, p); }