...
void CFrustum::setFromCameraParameters(float angle, float ratio, float nearD,
                                       float farD, glm::vec3 &pos,
                                       glm::vec3 &look, glm::vec3 &u)
{
...
void CFrustum::setFromViewProjectionClipSpaceApproach(const glm::mat4 &view,
                                                      const glm::mat4 &proj)
{
...
void CFrustum::setFromInverseViewProjection(const glm::mat4 &invViewProj)
{
  ...
  // Set frustum planes
  m_planes[Near].set3Points(glm::vec3(points[topRightNear]),
                            glm::vec3(points[topLeftNear]),
                            glm::vec3(points[bottomLeftNear]));
  m_planes[Far].set3Points(glm::vec3(points[topLeftFar]),
                           glm::vec3(points[topRightFar]),
                           glm::vec3(points[bottomRightFar]));
  m_planes[Left].set3Points(glm::vec3(points[bottomLeftFar]),
                            glm::vec3(points[bottomLeftNear]),
                            glm::vec3(points[topLeftNear]));
  m_planes[Right].set3Points(glm::vec3(points[topRightFar]),
                             glm::vec3(points[topRightNear]),
                             glm::vec3(points[bottomRightNear]));
  m_planes[Top].set3Points(glm::vec3(points[topLeftNear]),
                           glm::vec3(points[topRightNear]),
                           glm::vec3(points[topRightFar]));
  m_planes[Bottom].set3Points(glm::vec3(points[bottomLeftFar]),
                              glm::vec3(points[bottomRightFar]),
                              glm::vec3(points[bottomRightNear]));
}

void CFrustum::setFromViewProjection(const glm::mat4 &view,
                                     const glm::mat4 &proj)
{
