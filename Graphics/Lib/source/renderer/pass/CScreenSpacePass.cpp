#include "graphics/renderer/pass/CScreenSpacePass.h"
...
void CScreenSpacePass::draw(const IGraphicsResourceManager *manager, CFrameBuffer *fbo,
                            CTexture *texture0, CTexture *texture1, CTexture *texture2,
                            CTexture *texture3)
{
    if (m_shaderId == invalidResource)
    {
