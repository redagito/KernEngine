...
public:
  ...
  */
  void setValue(const std::string &group, const std::string &key,
  ...
  */
  const std::string &getValue(const std::string &group, const std::string &key,
                              const std::string &defaultValue) const;
  int getValue(const std::string &group, const std::string &key,
               int defaultValue) const;
  float getValue(const std::string &group, const std::string &key,
