...
public:
   ...
   */
  static void log(ELogLevel level, const char *file, int line,
  ...
  {
  public:
    CTempLogger(ELogLevel level, const char *file, int line,
                const char *function)
    ...
    ~CTempLogger()
    {
      CLogger::log(m_level, m_file, m_line, m_function, m_ss.str());
    }
