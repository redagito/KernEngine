...
void CIniFile::setValue(const std::string &group, const std::string &key,
...
const std::string &CIniFile::getValue(const std::string &group,
...
int CIniFile::getValue(const std::string &group, const std::string &key,
...
float CIniFile::getValue(const std::string &group, const std::string &key,
...
bool CIniFile::hasGroup(const std::string &group) const
{
  return d_entries.count(group) == 1;
}
