...
void AAsyncPort::setHandlerThread(const std::shared_ptr<AMessageHandlerThread> &handlerThread)
{
    m_handlerThread = handlerThread;
}

const std::shared_ptr<AMessageHandlerThread> &AAsyncPort::getHandlerThread() const
{
