...
bool AMessage::serialize(CBinaryWriter &writer) const { return writer.write(*this); }
...
void AMessage::setDeferredHandled(bool deferredHandled) { m_deferredHandled = deferredHandled; }
...
bool serialize(const AMessage &msg, std::ostream &os) { return msg.serialize(os); }

bool deserialize(AMessage &msg, std::istream &is) { return msg.deserialize(is); }