...
void AApplication::setCompanyName(const std::string &name)
{
  m_companyName = name;
}

const std::string &AApplication::getCompanyName() const
{
  return m_companyName;
}

void AApplication::setApplicationName(const std::string &name)
{
  m_applicationName = name;
}

const std::string &AApplication::getApplicationName() const
{
  return m_applicationName;
}

void AApplication::setApplicationId(const std::string &id)
{
  m_applicationId = id;
}

const std::string &AApplication::getApplicationId() const
{
...
const std::string &AApplication::getApplicationVersion() const
{
...
const Configuration &AApplication::getCommandLineArguments() const
{
