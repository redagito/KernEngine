...
class ShaderProgram
{
   public:
     ...
     */
    ShaderProgram(TShaderObject<GL_VERTEX_SHADER> *vertex,
     ...
     * still be valid with the data of the former initialization and an error
     * string
    ...
    bool setUniform(Texture &texture, const std::string &textureName, GLint textureUnit);
