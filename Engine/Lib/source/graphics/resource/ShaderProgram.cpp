...
bool ShaderProgram::isValid() const { return m_valid; }
...
bool ShaderProgram::setUniform(GLint location, int i)
{
    if (location == -1)
    {
        return false;
...
bool ShaderProgram::setUniform(const std::string &name, const glm::vec2 &v)
{
    return setUniform(getUniformLocation(name), v);
}

bool ShaderProgram::setUniform(GLint location, const glm::vec3 &v)
{
    if (location == -1)
    {
        return false;
...
bool ShaderProgram::setUniform(const std::string &name, const glm::vec3 &v)
{
    return setUniform(getUniformLocation(name), v);
}

bool ShaderProgram::setUniform(GLint location, const glm::vec4 &v)
{
    if (location == -1)
    {
        return false;
...
bool ShaderProgram::setUniform(const std::string &name, const glm::vec4 &v)
{
    return setUniform(getUniformLocation(name), v);
}

bool ShaderProgram::setUniform(GLint location, const glm::mat2 &m)
{
    if (location == -1)
    {
        return false;
...
bool ShaderProgram::setUniform(const std::string &name, const glm::mat2 &m)
{
    return setUniform(getUniformLocation(name), m);
}

bool ShaderProgram::setUniform(GLint location, const glm::mat3 &m)
{
    if (location == -1)
    {
        return false;
...
bool ShaderProgram::setUniform(const std::string &name, const glm::mat3 &m)
{
    return setUniform(getUniformLocation(name), m);
}

bool ShaderProgram::setUniform(GLint location, const glm::mat4 &m)
{
    if (location == -1)
    {
        return false;
...
bool ShaderProgram::setUniform(const std::string &name, const glm::mat4 &m)
{
    return setUniform(getUniformLocation(name), m);
}
