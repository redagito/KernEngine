...
LoseState::LoseState(const std::string &sceneFile) : m_sceneFile(sceneFile) {}
...
bool LoseState::update(float dtime)
{
...
const std::string &LoseState::getNextState() const { return gameStr; }