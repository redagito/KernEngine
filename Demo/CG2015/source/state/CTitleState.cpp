...
CTitleState::CTitleState(const std::string &sceneFile) : m_sceneFile(sceneFile) {}
...
bool CTitleState::init(IGraphicsSystem *graphicsSystem, IInputProvider *inputProvider,
...
const std::string &CTitleState::getNextState() const { return gameStr; }