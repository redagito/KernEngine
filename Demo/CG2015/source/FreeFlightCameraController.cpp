...
FreeFlightCameraController::FreeFlightCameraController() {}
...
void FreeFlightCameraController::setCamera(std::shared_ptr<IControllableCamera> camera) { m_camera = camera; }

void FreeFlightCameraController::setInputProvider(IInputProvider *provider)
{
    if (m_inputProvider != nullptr)
    {
        m_inputProvider->removeInputListener(this);
...
bool FreeFlightCameraController::loadSequence(const std::string &file)
{
    m_sequenceTime = 0;
...
void FreeFlightCameraController::animate(float dt)
{
...
void FreeFlightCameraController::animateFeatures(float dt)
{
    // tODO
}

void FreeFlightCameraController::animateSequence(float dt)
{
...
void FreeFlightCameraController::animateManual(float dt)
{
...
void FreeFlightCameraController::handleKeyEvent(EKeyEventType type, int keyCode)
{
...
void FreeFlightCameraController::handleMouseMovementEvent(int x, int y)
{
...
void FreeFlightCameraController::handleResizeEvent(int width, int height)
{
