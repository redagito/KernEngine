 ...
 * other side.
 */
class RestrictPositionController : public IGameObjectController
{
   public:
    RestrictPositionController(const glm::vec2 &minCoords, const glm::vec2 &maxCoords);

    /**
     * \brief Destructor for cleanup.
     */
    ~RestrictPositionController();
